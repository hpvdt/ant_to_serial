...
try:
    ...
    while (1):
        ...
        # print to serial here  - 'A' 

        # microController.sendDataBytes(front_cur_hr, front_cur_cad, 
        #     front_cur_pwr, rear_cur_hr, rear_cur_cad, rear_cur_pwr)
        microController.sendDataBytes(100, 100, 
            300, 100, 100, 100)

        # microController.sendData('A', str(front_cur_hr))
        # microController.sendData('C', str(front_cur_cad))
        # microController.sendData('E', str(front_cur_pwr))
        # microController.sendData('B', str(rear_cur_hr))
        # microController.sendData('D', str(rear_cur_cad))
        # microController.sendData('F', str(rear_cur_pwr))
        #
